    ...
    <div>
      ...
      {error && (
        ...
        {!loading && !error && isDesktop && (
            ...
            <h1 className="my-6 p-2 text-4xl font-bold">List of <span>{emulatorName}</span> Emulators</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-4">
                {emulators.map((emulators, index) => (
                    <GameCard
                        ...
                        imgUrl={emulators.icon || "https://via.placeholder.com/250x350?text=Game"}
                        categorySlug='Emulator'
                        onClick={ () => navigate(`/emulators/${slug}/${emulators._id}`,{
                            state: {
        ...
        {!loading && !error && isMobile && (
            <div className="p-4">
            <h1 className="my-4 p-2 text-2xl font-bold">List of <span>{emulatorName}</span> Emulators</h1>
